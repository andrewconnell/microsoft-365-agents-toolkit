 ...
 * Specify and consolidates authorization related information for the App.
 */
export interface TeamsManifestV1D24Authorization {
    /**
...
export class Convert {
    public static toTeamsManifestV1D24(json: string): TeamsManifestV1D24 {
        return cast(JSON.parse(json), r("TeamsManifestV1D24"));
    }

    public static teamsManifestV1D24ToJson(value: TeamsManifestV1D24): string {
